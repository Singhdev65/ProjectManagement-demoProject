...
const ViewTeam = () => {
    ...
    return (
        ...
        {members.filter((doc) => (doc.id === teamId)).map(member => (
            ...
            <div className="viewTeam__LeftTop">
              ...
              <div className="viewTeam__ShowInfo">
                ...
                <span className="viewTeam__ShowInfoTitle">{member.data.experience}years</span>
              </div>
              <div className="viewTeam__ShowInfo">
                <PhoneAndroid className="viewTeam__ShowIcon" />
                <span className="viewTeam__ShowInfoTitle">{member.data.phone}</span>
              </div>
              <div className="viewTeam__ShowInfo">
                <MailOutline className="viewTeam__ShowIcon" />
                <span className="viewTeam__ShowInfoTitle">{member.data.email}</span>
              </div>
        </div>
       ))}
